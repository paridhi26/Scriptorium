...
INSERT INTO "new_Comment" ("blogPostId", "content", "createdAt", "id", "parentCommentId", "userId") SELECT "blogPostId", "content", "createdAt", "id", "parentCommentId", "userId" FROM "Comment";
DROP TABLE "Comment";
